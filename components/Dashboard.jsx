  ...
  return (
    <div>
      <div className="p-2 grid md:grid-cols-3">
        <div className="col-span-2">
          <div className="relative bg-slate-800 rounded-lg h-[400px] w-full">
            ...
            <div className="absolute flex flex-col bottom-3 right-3">
              <button type="button" className="rounded-full my-2 p-2 bg-white">
                <Upload />
              </button>
              <button type="button" className="rounded-full p-2 bg-white">
                <Scan />
              </button>
            </div>
          </div>
        ...
        <div className="bg-slate-800 ml-2 my-1 rounded-lg h-[530px]"></div>
      </div>
    </div>
  );
};
